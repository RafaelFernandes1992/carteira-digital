<div class="sidebar border border-right col-sm-4 col-md-3 col-lg-2 p-0 bg-body-tertiary" style="height: 100vh">

    <div class="d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">

        <h3 class="navbar-brand me-0 px-3 custom-title text-white p-2">
            Carteira Digital
        </h3>
