    ...
    <div class="table-responsive small">
        <table class="table table-striped table-sm">
            ...
            <tr>
                ...
                <th scope="col" style="text-align: begin;">Limite</th>
                <th scope="col" style="text-align: begin;">Dia Vencimento</th>
                <th scope="col" style="text-align: begin;">Fechamento</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width:15%; text-align: begin; vertical-align: middle;">{{ 0 }}</td>
                    <td style="width:13%; text-align: begin; vertical-align: middle;">{{ 0 }}</td>
                    ...
                    <td style="width:14%; text-align: center; vertical-align: middle;">
                        <div class="d-flex justify-content-center gap-2">
                            ...
                            <form action="{{ route('cartao-credito.destroy', 0) }}" method="POST">
                                @method('DELETE')
